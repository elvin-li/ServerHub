...
describe('a failed first load explains itself', () => {
  ...
  const CASES = [
    ...
    { name: 'Maintenance', load: () => import('./Maintenance.vue'), api: ['getMaintenance'], empty: 'maintenance.empty_hint' },
    { name: 'Scheduler', load: () => import('./Scheduler.vue'), api: ['getSchedulerJobs'], empty: 'sched.no_jobs' },
